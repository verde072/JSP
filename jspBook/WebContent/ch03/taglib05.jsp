...
<body>
	<%
		...
		fruitList.add("바나나");
		fruitList.add("배");
		//pageContext객체: page scope(영역)의 개체
		pageContext.setAttribute("fruitList", fruitList);
	%>
	<!--items의 fruitList는 pageContext객체의 속셕명 fruitList에 매핑된 데이터를 의미함  -->
...
<!-- memberVOList: [memberVO{memId:a001,memName:김은대}, 
					memberVO{memId:a001,memName:이쁜이},
					memberVO{memId:a001,memName:최용한}]
