	...
	<form action="form01_process.jsp" name="member" method="post">
		...
		<p>
			<select name="food"> 
				...
				<optgroup label="찌개류">
					<option value="dainjangjjigae">된찌</option>
					<option value="budaejjigae">부찌</option>
					<option value="kimchijjigae">김찌</option>
				</optgroup>
			</select>
		</p>
